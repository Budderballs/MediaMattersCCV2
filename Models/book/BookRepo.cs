...
namespace MediaMattersCCV2.Models.book
{
    public class BookRepo : IBook
    {
        ...
        public IEnumerable<Book> getBooks() =>
            new List<Book>
            {
                new Book{ISBN = "978-0-670-81364-3", image="~/images/Books/Misery.jpg", aFirstName = "Stephen", aLastName = "King", edition = "n/a", bTitle= "Misery", pDate = "June 8, 1987", notes = "I really enjoy Stephen King books, and while it took a couple attemps to read this book, as I kept losing focus, I liked it in the end." },
                ...
                new Book{ISBN = "0-440-21172-7", image="~/images/Books/ATTK.jpg", aFirstName = "John", aLastName = "Grisham", edition = "n/a", bTitle= "A Time to Kill", pDate = "1989", notes = "I read this book a bit young, but I sought out many Grisham novels afterwards and have liked them all so far" },
